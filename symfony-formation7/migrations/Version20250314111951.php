 ...
 */
final class Version20250314111951 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649D8646676 FOREIGN KEY (luser_id) REFERENCES user (id)');
