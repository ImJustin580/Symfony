 ...
 */
final class Version20250314112107 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inscription ADD luser_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE inscription ADD CONSTRAINT FK_5E90F6D6D8646676 FOREIGN KEY (luser_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_5E90F6D6D8646676 ON inscription (luser_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_5E90F6D6D8646676 ON inscription');
        $this->addSql('ALTER TABLE inscription DROP luser_id');
